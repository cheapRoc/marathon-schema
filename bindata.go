...
func schemasGroupJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "schemas/Group.json", size: 1830, mode: os.FileMode(420), modTime: time.Unix(1480624974, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
